...
class BankTransactionLogTotal:
    def __init__(self, transaction_log_string_list_helper: TransactionLogStringListHelper):
        self._transaction_log_string_list_helper = transaction_log_string_list_helper
    ...
    def _get_user_transaction_log(self) -> list[str]:
        ...
        return self._transaction_log_string_list_helper.get_validated_transaction_log_string_list(user_input)
