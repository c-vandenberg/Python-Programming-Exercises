...
class SubstringFrequencyCalculator:
    def __init__(
        ...
        self._substring_frequency_string_list_helper = substring_frequency_string_list_helper
    ...
    def _get_user_input(self):
        ...
        return self._substring_frequency_string_list_helper.get_validated_substring_frequency_string_list(user_input)
    ...
    def calculate_substring_frequency(self):
        ...
        self._counter.update(user_input_string_list)

        substring_frequency: list[str] = []

        for element, count in self._counter.items():
